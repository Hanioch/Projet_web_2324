...
?>
    ...
    <div class="row justify-content-center align-items-center">
        ...
        <form id="<?= $id_form ?>" class="p-3 border rounded-4 text-white text-center" action="notes/edit_checklist_note/<?=$note->getId()?>" method="post">
            <div class="mb-3">
                <div class="">
                    <label for="title_edit_checklist_note" class="form-label">Title</label>
                    <input type="text" value="<?= $note->getTitle() ?>" name="title" class="form-control" id="title_edit_checklist_note">
                    <?php
