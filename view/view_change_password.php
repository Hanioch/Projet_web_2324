        ...
        <form class=" text-white" action="Settings/change_password" method="post">
            <div class="form-group m-3">
                ...
                <div class="input-group">
                    <input type="password" class="form-control <?php if (count($errors["old_password"]) > 0): ?>is-invalid<?php endif; ?>" id="old_password" name="old_password" placeholder="Old" autocomplete="off">
                </div>
