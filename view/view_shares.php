                        ...
                        <?php foreach ($existingShares as $share): ?>
                            <div class="input-group mb-3 ">
                                ...
                                <form action="./notes/shares/<?php echo $noteId; ?>" method="post" >
                                    ...
                                    <button class="btn btn-primary border-secondary" type="submit" name="changePermission">
                                        <i class="bi bi-arrow-repeat"></i>
                                    </button>
                                </form>
                                <form action="./notes/shares/<?php echo $noteId; ?>" method="post" >
                                    <input type="hidden" name="user" value="<?=$share['user']?>">
                                    <button class="btn btn-danger border-secondary" type="submit" name="removeShare">
                                        <i class="bi bi-x"></i>
                                    </button>
                                </form>
                            </div>
